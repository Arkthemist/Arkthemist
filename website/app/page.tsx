					...
					<div className="max-w-7xl mx-auto">
						<div className="text-center mb-8">
							...
							<p className="text-muted-foreground text-lg md:text-xl max-w-2xl mx-auto">
								Resolve financial disputes on Starknet with an
								AI mediator trained with specialized
								legislation, ensuring transparent and fair
								conflict resolution
							</p>
						</div>
								...
								<div className="grid grid-cols-1 md:grid-cols-3 gap-8">
									<div className="flex flex-col items-center text-center group">
										...
										<p className="text-muted-foreground">
											Consult our AI advisor trained in
											relevant law and cases to understand
											your case
										</p>
									</div>
									<div className="flex flex-col items-center text-center group">
										...
										<p className="text-muted-foreground">
											Start your dispute resolution
											process with clear documentation and
											evidence
										</p>
									</div>
									<div className="flex flex-col items-center text-center group">
										...
										<p className="text-muted-foreground">
											Let our AI analyze evidence and
											deliver a fair, transparent
											resolution
										</p>
									</div>
								</div>
							...
							<div className="relative">
								...
								<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
									<div className="group p-6 rounded-2xl bg-gradient-to-tr from-card/90 via-card/70 to-accent/[0.08] border border-border hover:border-accent transition-all hover:shadow-[0_0_1rem_-0.25rem_theme(colors.accent.DEFAULT)] duration-300">
										...
										<p className="text-muted-foreground">
											Advanced AI trained in Costa Rican
											law for accurate dispute resolution
										</p>
									</div>
									<div className="group p-6 rounded-2xl bg-gradient-to-tr from-card/90 via-card/70 to-accent/[0.08] border border-border hover:border-accent transition-all hover:shadow-[0_0_1rem_-0.25rem_theme(colors.accent.DEFAULT)] duration-300">
										<div className="h-48 rounded-xl bg-gradient-to-tr from-secondary/80 to-secondary/30 mb-4 overflow-hidden relative">
										...
										<p className="text-muted-foreground">
											Immutable record-keeping and secure
											fund management on Starknet
										</p>
									</div>
									<div className="group p-6 rounded-2xl bg-gradient-to-tr from-card/90 via-card/70 to-accent/[0.08] border border-border hover:border-accent transition-all hover:shadow-[0_0_1rem_-0.25rem_theme(colors.accent.DEFAULT)] duration-300">
										<div className="h-48 rounded-xl bg-gradient-to-tr from-secondary/80 to-secondary/30 mb-4 overflow-hidden relative">
										...
										<p className="text-muted-foreground">
											Swift and efficient dispute handling
